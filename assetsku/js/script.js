...
// Dirubah 
const pengirim = "Fathul Hady Raya";
const nomorWa = "6283140482035" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja, Aku jadi sayang sama kamu"
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    imageUrl: "/assetsku/img/stiker_mylove.gif",
    imageHeight: 120,
